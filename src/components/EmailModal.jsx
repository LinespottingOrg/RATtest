...
function EmailModal({ data, prompt }) {
  ...
  const emailParams = ratEmailParams(data, userEmail)
  ...
  const sendEmail = () => {
    ...
    emailjs.send('service_zwdj6q5', 'template_eyzajr9', emailParams).then(
      (result) => {
  ...
  return (
    <>
      <Button prompt={prompt} onClick={() => document.getElementById('my_modal_5').showModal()} />
              ...
              <div className="flex items-center">
                {!isSent ? (
                  ...
                  <div className="flex items-center">
                    ...
                    <p className="md:ml-8">{t('resultpage.modal.confirmation')}</p>
                  </div>
                )}
              </div>
